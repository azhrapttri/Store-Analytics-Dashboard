...
# ─────────────────────────────────────────────
# DB CONFIG — sesuaikan dengan database kamu
# ─────────────────────────────────────────────
DB_CONFIG = {
    "host": "localhost",
    "database": "dvdrental",
...
MIN_MONTHS = 5  # Database hanya punya 5 bulan
...
def build_features():
    ...
    # ── ADDITIONAL FEATURES FOR SMALL DATA ───────────────────
    ...
    # FIXED: Outer query references sub.month, not r.rental_date
    hourly_peak = qry("""
        SELECT
            sub.month,
...
def train_model(df):
    ...
    # For 5 months: use all data for training, validate with LOO-CV
